...
| 2026-05-08 | フェーズ1→2間のロゴ吸い込み＋紙めくれトランジション実装をいったん取り下げ。HeroSection/SectionManager/関連CSSを直前の状態へ復元し、フェーズ2の既存調整は維持。 | Codex |
| 2026-05-11 | homepage閲覧時の重さについて現状コードを調査。初期マウントされる複数Canvas、GLB preload、常時frameloop、スクロールstate更新、ポストロード演出を主な軽量化候補として整理。 | Codex |
